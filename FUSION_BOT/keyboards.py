...
def settings_kb() -> InlineKeyboardMarkup:
    ...
    return InlineKeyboardMarkup(inline_keyboard=[
        ...
        [InlineKeyboardButton(text="━━━ QO'LDA SAVDO YORDAMCHISI ━━━", callback_data="noop")],
        [InlineKeyboardButton(text="💰 Foyda maqsadi ($) — yop", callback_data="set:close_at_usd")],
        [InlineKeyboardButton(text="✋ Faqat yopish rejimi (yoq/o'ch)", callback_data="user:toggle_onlyclose")],
